...
use "$OUT_STATA/data_cmogram_municipality_year.dta", clear
...
foreach var in dmedia dmedia_rd dmedia_cn dmedia_ch dmedia_lc ///
    ...
    graph export "$OUTPUTS/cmogram/`var'_cmogram.png", replace width(1600)
}
...
graph export "$OUTPUTS/cmogram/dmedia_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_rd_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_cn_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_ch_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_lc_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_mt_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_d1_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_d2_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_easy_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_hard_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_escm0_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_escm1_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_bra1_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_bra0_cmogram.png", replace width(1600)
...
graph export "$OUTPUTS/cmogram/dmedia_2018_cmogram.png", replace width(1600)	
