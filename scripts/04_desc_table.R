...
base <- readRDS(file = path_paste(all_observations_path, "base_nota_2019_mock.RDS")) %>%
  bind_rows(readRDS(file = path_paste(all_observations_path, "base_nota_2019_older.RDS"))) %>%
  filter(uf %in% c("RO", "AM", "PA", "TO", "BA", #NON-DST
                   "MT", "GO", "MG", "ES", "DF"))
...
temp <- readRDS(file = path_paste(all_observations_path, "enem_abs_2019_mock.RDS")) %>%
  bind_rows(readRDS(file = path_paste(all_observations_path, "enem_abs_2019_older.RDS"))) %>%
  filter(uf %in% c("RO", "AM", "PA", "TO", "BA", #NON-DST
                   "MT", "GO", "MG", "ES", "DF"))
...
base <- readRDS(file = path_paste(all_observations_path, "base_nota_2018_mock.RDS")) %>%
  bind_rows(readRDS(file = path_paste(all_observations_path, "base_nota_2018_older.RDS"))) %>%
  filter(uf %in% c("RO", "AM", "PA", "TO", "BA", #NON-DST
                   "MT", "GO", "MG", "ES", "DF"))
...
temp <- readRDS(file = path_paste(all_observations_path, "enem_abs_2018_mock.RDS")) %>%
  bind_rows(readRDS(file = path_paste(all_observations_path, "enem_abs_2018_older.RDS"))) %>%
  filter(uf %in% c("RO", "AM", "PA", "TO", "BA", #NON-DST
                   "MT", "GO", "MG", "ES", "DF"))
